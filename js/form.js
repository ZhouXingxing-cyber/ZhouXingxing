...
class FormValidator {
  ...
  getPeopleText(value) {
    ...
    const map = { 10: '10 人及以上' };
    return map[value] || `${num} 人`;
  }
  ...
  fillSummary(data) {
    const map = {
      ...
      summaryPeople: this.getPeopleText(data.people) || '—',
      summaryAttraction: this.getAttractionName(data.attraction) || '—'
    };
